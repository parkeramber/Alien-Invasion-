...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Tell pygame to determine the size of the screen and set the screen width and height based on the player's screen size
        self.screen = pygame.display.set_mode((0, 0), pygame.FULLSCREEN)
        self.settings.screen_width = self.screen.get_rect().width
        self.settings.screen_height = self.screen.get_rect().height
        pygame.display.set_caption("Ambers Zombie Brain Invasion")
    ...
    def run_game(self):
        ...
        while True:
            # Call a method to check if any keyboard events have occurred
            self._check_events()
            
            # Check if the game is still active (more ships left)
    ...
    def _check_keydown_events(self, event):
        # Is the key the right arrow or the left arrow?
    ...
    def _fire_bullet(self):
        ...
        # Limit the number of bullets a player can have at a time by adding a constant to the settings file
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Increase the score for each alien hit
        if collisions:
            self.stats.score += len(collisions)
        
        # Check if the aliens group is empty and if so, create a new fleet
        if not self.aliens:
    ...
    def _create_fleet(self):
        ...
        number_rows = 4  # Updated to 4 rows
    ...
    def _create_alien(self, alien_number, row_number):
        ...
        aliens.rect.y = alien_height + 1.5 * aliens.rect.height * row_number
    ...
    def _update_screen(self):
        ...
        # Draw the number of ships left and the number of aliens killed
        self._draw_ships_left()
        self._draw_aliens_killed()
    ...
    def _draw_ships_left(self):
        ...
        ships_left_text = font.render("Zombies Left: " + str(self.stats.ships_left), True, (0, 0, 0))
        self.screen.blit(ships_left_text, (10, 10))
        
    def _draw_aliens_killed(self):
        # Display the number of aliens killed
        font = pygame.font.SysFont(None, 48)
        aliens_killed_text = font.render("Brain's Destroyed: " + str(self.stats.score), True, (0, 0, 0))
        self.screen.blit(aliens_killed_text, (10, 60))
        
    def _game_over(self):
        # Display "Game Over" and the player's score
        font = pygame.font.SysFont(None, 80)  # Increase font size to 80
        
        game_over_text = font.render("Game Over", True, (0, 0, 0))  # Change color to black
        score_text = font.render("Score: " + str(self.stats.score), True, (0, 0, 0))  # Change color to black
        game_name_text = font.render("Amber's Zombie Brain Invasion", True, (0, 0, 0))
        game_over_rect = game_over_text.get_rect()
        score_rect = score_text.get_rect()
        game_over_rect.center = self.screen.get_rect().center
        score_rect.centerx = self.screen.get_rect().centerx
        score_rect.top = game_over_rect.bottom + 10
        self.screen.blit(game_name_text, (self.screen.get_rect().centerx - game_name_text.get_width() // 2, 125))
